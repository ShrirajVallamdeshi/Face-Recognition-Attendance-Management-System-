...
# Testing Connection 
"""
conn = mysql.connector.connect(username='root', password='vinay',host='localhost',database='face_recognition')
cursor = conn.cursor()
...
class Student:
    ...
    # This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\91883\Desktop\python Project\Python-FYP-Face-Recognition-Attendence-System-master\sgh\Background_Ai.JPG")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Student Details",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=700,height=45)

        # Creating Frame 
        main_frame = Frame(bg_img,bd=2,bg="white") #bd mean border 
        main_frame.place(x=5,y=55,width=1355,height=610)
        ...
        dep_combo["values"]=("Select Department","AI&DS","CSE","ENTC","ELEC.","MECH","CIVIL")
        dep_combo.current(0)
